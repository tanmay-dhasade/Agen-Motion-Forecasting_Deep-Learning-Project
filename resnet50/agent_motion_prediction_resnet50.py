...
"""
rc = subprocess.call('/home/trdhasade/resnet50/setup_local_data.sh')
...
# get config
cfg = load_config_data("/home/trdhasade/resnet50/agent_motion_config_resnet50.yaml")
print(cfg)
...
df.to_csv('/home/trdhasade/resnet50/resnet50MSE_loss.csv')

torch.save(model, '/home/trdhasade/Out/resnet50MSE_fulltrain.pth')
